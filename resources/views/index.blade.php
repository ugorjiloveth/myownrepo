					...
					<div class="row">
						<div class="col-lg-6">
							<div class="home_left_img">
								<img src="{{asset('/img/banner/home-left-1.png')}}" alt="">
							</div>
						</div>
						<div class="col-lg-6">
        	...
        	<div class="container">
        		...
        		<div class="row latest_blog_inner">
        			<div class="col-lg-4">
        				<div class="l_blog_item">
        					<div class="l_blog_img">
        						<img class="img-fluid" src="{{asset('/img/blog/home-blog/home-blog-1.jpg')}}" alt="">
        					</div>
        			...
        			<div class="col-lg-4">
        				<div class="l_blog_item">
        					<div class="l_blog_img">
        						<img class="img-fluid" src="{{asset('/img/blog/home-blog/home-blog-2.jpg')}}" alt="">
        					</div>
        					<div class="l_blog_text">
        						<div class="date">
        							<a href="#">25 October, 2017  |  By Mark Wiens</a>
        			...
        			<div class="col-lg-4">
        				<div class="l_blog_item">
        					<div class="l_blog_img">
        						<img class="img-fluid" src="{{asset('/img/blog/home-blog/home-blog-3.jpg')}}" alt="">
        					</div>
        					<div class="l_blog_text">
        						<div class="date">
        							<a href="#">25 October, 2017  |  By Mark Wiens</a>
